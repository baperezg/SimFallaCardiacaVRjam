...
function PostNotification (aNotification: Notification) {
    ...
    var notifyList: List.<Component> = notifications[aNotification.name];
    if (!notifyList) { Debug.Log("Notify list not found in PostNotification: " + aNotification.name); return; }
